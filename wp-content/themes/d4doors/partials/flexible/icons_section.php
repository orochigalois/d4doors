...
<section class="icons_section" id="<?= $random__id; ?>">
  <div class="container">
    <div class="wrapper">
      <?php
      if (have_rows('repeater')) :
        while (have_rows('repeater')) : the_row(); ?>
          ...
          ?>
            <a class="each" href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">
                <div class="each__img">
                  <img src="<?= get_sub_field('image')['url']; ?>" alt="">
                </div>
                
                <div class="each__text">
                  <h6><?= get_sub_field('title'); ?></h6>
                  <?php if(false): ?>
                  <p class="fs14"><?= get_sub_field('text'); ?></p>
                  <?php endif; ?>
                </div>
