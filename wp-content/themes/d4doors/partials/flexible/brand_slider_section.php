...
<section class="brand_slider_section" id="<?= $random__id; ?>">
  <div class="container">
    <div class="wrapper">
      <?php if (have_rows('repeater')) : ?>
        <div class="slider-class">
          <?php while (have_rows('repeater')) : the_row(); ?>
            <div class="item">
              <div class="img__wrap">
                <?php if (get_sub_field('logo1')) : ?>
                  <img src="<?= get_sub_field('logo1')['url']; ?>" alt="">
                <?php endif; ?>
                <?php if (get_sub_field('logo2')) : ?>
                  <img src="<?= get_sub_field('logo2')['url']; ?>" alt="">
                <?php endif; ?>
                <?php if (get_sub_field('logo3')) : ?>
                  <img src="<?= get_sub_field('logo3')['url']; ?>" alt="">
                <?php endif; ?>
                <?php if (get_sub_field('logo4')) : ?>
                  <img src="<?= get_sub_field('logo4')['url']; ?>" alt="">
                <?php endif; ?>
                <?php if (get_sub_field('logo5')) : ?>
                  <img src="<?= get_sub_field('logo5')['url']; ?>" alt="">
                <?php endif; ?>
                <?php if (get_sub_field('logo6')) : ?>
                  <img src="<?= get_sub_field('logo6')['url']; ?>" alt="">
                <?php endif; ?>
