...
<section class="static_brands_section" id="<?= $random__id; ?>">
  <div class="container">
    <div class="wrapper">
      <?php 
      ...
      if( $link ): 
        ...
        ?>
        <a href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>"><img src="<?= get_sub_field('image_1')['url']; ?>" alt=""></a>
        <?php else: ?>
        <img src="<?= get_sub_field('image_1')['url']; ?>" alt="">
      <?php endif; ?>
      <?php 
      ...
      if( $link ): 
        ...
        $link_target = $link['target'] ? $link['target'] : '_self';
        ?>
        <a href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>"><img src="<?= get_sub_field('image_2')['url']; ?>" alt=""></a>
        <?php else: ?>
        <img src="<?= get_sub_field('image_2')['url']; ?>" alt="">
      <?php endif; ?>
      <?php 
      ...
      if( $link ): 
        ...
        $link_target = $link['target'] ? $link['target'] : '_self';
        ?>
        <a href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>"><img src="<?= get_sub_field('image_3')['url']; ?>" alt=""></a>
      <?php else: ?>
        <img src="<?= get_sub_field('image_3')['url']; ?>" alt="">
      <?php endif; ?>
